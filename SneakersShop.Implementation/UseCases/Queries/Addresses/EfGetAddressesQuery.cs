...
public class EfGetAddressesQuery(SneakersShopDbContext context, IApplicationUser? user) : EfUseCase(context, user), IGetAddressesQuery
{
    public int Id => 34;
    ...
    public IEnumerable<AddressDto> Execute(BaseSearch search)
    {
        if (User == null)
        {
